...
<body>
<a href="#show-tekMessage" class="skip" tabindex="-1">
...
<div id="show-tekMessage" class="content scaffold-show" role="main">
        ...
        <g:if test="${tekMessageInstance?.parent}">
            <li class="fieldcontain">
                <span id="parent-label" class="property-label">
                    <g:message code="tekMessage.parent.label" default="Parent"/></span>
            ...
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="author-label">
                    <g:link controller="tekUser" action="show"
                            id="${tekMessageInstance?.author?.id}">${tekMessageInstance?.author?.encodeAsHTML()}</g:link></span>
        ...
        <g:if test="${tekMessageInstance?.event}">
            <li class="fieldcontain">
                <span id="event-label" class="property-label">
                    <g:message code="tekMessage.event.label" default="Event"/></span>

                <span class="property-value" aria-labelledby="event-label">
                    <g:link controller="tekEvent" action="show"
                            id="${tekMessageInstance?.event?.id}">${tekMessageInstance?.event?.encodeAsHTML()}</g:link></span>
    ...
    <g:form url="[resource: tekMessageInstance, action: 'delete']" method="DELETE">
        <fieldset class="buttons">
            <g:link class="edit" action="edit" resource="${tekMessageInstance}">
