...
<head>
    ...
    %{--    <script src="https://code.jquery.com/jquery-1.11.1.min.js"></script>
        ...
        <link rel="stylesheet" href="https://code.jquery.com/ui/1.11.1/themes/smoothness/jquery-ui.css" type="text/css"/>--}%
...
<body>
<a href="#show-tekEvent" class="skip" tabindex="-1"><g:message
...
<div class="nav" role="navigation">
    <ul>
        ...
        <li><g:link class="list" controller="dashboard" action="dashboard" id="${tekEventInstance.id}">
            Event Dashboard</g:link></li>
...
<div id="show-tekEvent" class="content scaffold-show" role="main">
        ...
        <g:if test="${tekEventInstance?.respondents}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="respondents-label">
                    <g:fieldValue bean="${tekEventInstance}" field="respondents"/>
                </span>
    ...
    <g:form url="[resource: tekEventInstance, action: 'delete']"
            method="DELETE">
...
<head>
    ...
    <script src="https://code.jquery.com/jquery-1.11.1.min.js"></script>
    <script src="https://code.jquery.com/ui/1.11.1/jquery-ui.min.js"></script>
    <link rel="stylesheet" href="${resource(dir: '/assets/stylesheets', file: 'jquery-ui.css')}" type="text/css"/>

%{--<link rel="stylesheet" href="https://code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css" type="text/css"/>--}%%{--

   <link rel="stylesheet" href="${resource(dir: '/assets/stylesheets', file: 'main.css')}" type="text/css"/>
    <title><g:message code="default.show.label" args="[entityName]"/></title>
</head>
<body>
<a href="#show-tekEvent" class="skip" tabindex="-1"><g:message
