...
class TekMessageController {
    ...
    def index(Integer max) {
        ...
        render view:'ajaxIndex',
                model:[tekMessageInstanceList: list,
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.updated.message',
                        args: [message(code: 'TekMessage.label',
                                default: 'TekMessage'), tekMessageInstance.id])
    ...
    def showDetail() {
        ...
        if (tekMessageInstance) {
            render(template:"details",
                    model:[tekMessageInstance:tekMessageInstance])
        }
        else {
